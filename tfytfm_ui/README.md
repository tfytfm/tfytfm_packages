...
Tfytfm UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── tfytfm_icons_dark.dart
│   │       │      ├── tfytfm_icons_light.dart
│   │       │      └── tfytfm_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── tfytfm_app_bar.dart
│   │             ├── tfytfm_outlined_button.dart
│   │             └── tfytfm_text_field.dart 
│   ├── tfytfm_ui.dart
│   ├── .gitignore
...
```
2) In `tfytfm_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `tfytfm_icons_dark.dart` add the icon with its color respectively of the theme. 
